...
Mycroft.Delegate {
    ...
    ListModel {
        ...
        ListElement {
            text: "Very high accuracy"
        }
        ListElement {
            text: "Does not work without internet"
        }
    }
    ...
    Rectangle {
        ...
        Item {
            ...
            ColumnLayout {
                ...
                Label {
                    ...
                    text: "Google runs on the cloud, it is highly accurate
                    but may not respect your privacy"
                }
        ...
        RowLayout {
            ...
            Button {
                ...
                onClicked: {
                    triggerGuiEvent("mycroft.return.select.stt",
                    {"page": "google"})
                }
            }
